            ...
            <div>
                <div>
                    <div className='text-left flex gap-3'>
                        <button onClick={()=>navigate('/login')} className='bg-[#0bec59df] py-2 px-6 rounded-[99px] text-white uppercase'>Log In</button>
                        <button onClick={()=>navigate('/signup')} className='border-[1px] border-[#0bec59df] border-solid rounded-[99px] py-2 px-6 uppercase'>Sign Up</button>
                    </div>
                    <div className='mt-9'>
